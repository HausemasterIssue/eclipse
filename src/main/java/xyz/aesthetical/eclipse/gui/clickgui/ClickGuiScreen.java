package xyz.aesthetical.eclipse.gui.clickgui;

import net.minecraft.client.gui.GuiScreen;
import org.lwjgl.input.Mouse;
import xyz.aesthetical.eclipse.Eclipse;
import xyz.aesthetical.eclipse.features.modules.client.ClickGUI;
import xyz.aesthetical.eclipse.gui.clickgui.components.Container;
import xyz.aesthetical.eclipse.gui.clickgui.components.buttons.ModuleButton;
...
public class ClickGuiScreen extends GuiScreen {
    ...
    private ClickGuiScreen() {
        ...
        for (Pair<String, List<Module>> pair : Eclipse.moduleManager.getModulesSortedByCategory()) {
