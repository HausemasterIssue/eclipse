...
import xyz.aesthetical.eclipse.gui.clickgui.components.other.EnumSelection;
import xyz.aesthetical.eclipse.gui.clickgui.components.other.Slider;
...
public class ModuleButton extends Button {
    ...
    public void draw(int mouseX, int mouseY, float tickDelta) {
        ...
        Eclipse.textManager.draw(module.getName(), (float) (x + 2.3), toCenterHeight((float) y, (float) height), -1);
