...
import xyz.aesthetical.eclipse.features.modules.movement.speed.Bhop;
import xyz.aesthetical.eclipse.features.modules.movement.speed.Strafe;
import xyz.aesthetical.eclipse.features.modules.movement.speed.Vanilla;
...
public class Speed extends Module {
    ...
    private final Map<Mode, xyz.aesthetical.eclipse.managers.modules.Mode> modes = new HashMap<>();
    private xyz.aesthetical.eclipse.managers.modules.Mode previous;
    ...
    public void onUpdate(LivingEvent.LivingUpdateEvent event) {
        if (Module.fullNullCheck() && event.getEntityLiving() == Eclipse.mc.player) {
            if (previous == null || !previous.getName().equalsIgnoreCase(mode.getValue().name())) {
                ...
                xyz.aesthetical.eclipse.managers.modules.Mode possibleMode = modes.get(mode.getValue());
