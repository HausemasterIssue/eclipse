...
public class Scaffold extends Module {
    ...
    public void onMove(MoveEvent event) {
        if (Module.fullNullCheck()) {
            if (tower.getValue() && Astra.mc.gameSettings.keyBindJump.isKeyDown()) {
                Astra.mc.player.motionY = 0.4;
            }

            BlockPos pos = new BlockPos(Astra.mc.player.getPositionVector()).add(0, -1, 0);
