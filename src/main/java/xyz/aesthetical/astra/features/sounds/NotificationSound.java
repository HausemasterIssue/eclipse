package xyz.aesthetical.astra.features.sounds;
    ...
    static {
        sound = new ISound() {
            ...
            public SoundEventAccessor createAccessor(SoundHandler handler) {
                return new SoundEventAccessor(resource, "Astra Notification");
            }
            ...
            public float getXPosF() {
                return Astra.mc.player.getPosition().getX();
            }

            @Override
            public float getYPosF() {
                return Astra.mc.player.getPosition().getY();
            }

            @Override
            public float getZPosF() {
                return Astra.mc.player.getPosition().getZ();
            }
